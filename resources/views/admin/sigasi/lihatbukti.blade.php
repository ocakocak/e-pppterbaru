        ...
        <div class="card-body">
            ...
            <center>
                <h4 style="color:#6a381f">File Bukti Prestasi Sedang Di Unduh <iframe
                        src="{{ asset('storage/prestasi/'.$data_bukti->file_bukti_prestasi)}}" width="0"
                        height="0"></iframe></h4>

            </center>
            @elseif($data_bukti->extension == "pdf")
            <iframe src="{{ asset('storage/prestasi/'.$data_bukti->file_bukti_prestasi)}}" width="1000"
                height="650"></iframe>
            @else
            <img src="{{ asset('storage/prestasi/'.$data_bukti->file_bukti_prestasi)}}" width="100%">
            @endif
            @endif
        </div>
