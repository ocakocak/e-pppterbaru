        ...
        <div class="card-body">
            ...
            <center>
                <h4 style="color:#6a381f">File Surat Permohonan ke
                    ...
                    @endif
                    Sedang Di Unduh
                    <iframe src="{{ asset('storage/surat/'.$data_sigasi->file_bukti_surat)}}" width="0"
                        height="0"></iframe>
                </h4>

            </center>
            @elseif($data_sigasi->extension_file_bukti_surat == "pdf")
            <iframe src="{{ asset('storage/surat/'.$data_sigasi->file_bukti_surat)}}" width="1000"
                height="650"></iframe>
            @else
            <img src="{{ asset('storage/surat/'.$data_sigasi->file_bukti_surat)}}" width="100%">
            @endif
            @endif
        </div>
