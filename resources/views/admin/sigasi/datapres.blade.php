                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tbody>
							...
							<form action="{{route('updatekronologis',$dg->id_sigasi)}}" method="post" enctype="multipart/form-data">
								@csrf
								@method('patch')
								...
								<div class="form-group row mr-3 ml-3">
									...
									<button class="btn-user btn btn-action btn-polda float-right" style="color:white" type="submit">Ubah file</button>
							</form>
                                                    </div>
								...
								<a href="{{ route('hapusbuktiprestasi', $databukti->id_bukti_prestasi) }}">
							...
							// DISINI
                                    ...
                                    @elseif(auth()->user()->id_aktor==2)
	               			@if($dg->personil->id_kesatuan == 11)
                                    No Surat : {{$dg->no_file_bukti_surat}} <br> Sedang di Verifikasi POLDA
                                    @else
                                    No Surat : {{$dg->nosuratadmin}} <br> Sedang di Verifikasi POLDA
                                    @endif
